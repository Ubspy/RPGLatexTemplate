...
% Set the document class to a book
% I wanted to use memoir because supposedly it provides more functionality
% but I could not get it to change any of the stuff in the table of contents
